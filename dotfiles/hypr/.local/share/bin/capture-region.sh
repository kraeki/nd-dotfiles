...
#
# Ported from Omarchy 4's omarchy-capture-region. Only the runtime marker
# paths were renamed; the picker logic is upstream's.
...
# surface (see hyprland.lua) invoke these modes. The
