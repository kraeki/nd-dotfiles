...
hl.define_submap("rofiselect", function()
    hl.bind("W", hl.dsp.exec_cmd("hyprctl dispatch submap reset && vicinae vicinae://extensions/dagimg-dot/wifi-commander/scan-wifi"))
    hl.bind("A", hl.dsp.exec_cmd("hyprctl dispatch submap reset && vicinae vicinae://extensions/rastsislaux/pulseaudio/pulseaudio"))
    hl.bind("B", hl.dsp.exec_cmd("hyprctl dispatch submap reset && vicinae vicinae://extensions/Gelei/bluetooth/scan"))
    hl.bind("M", hl.dsp.exec_cmd("hyprctl dispatch submap reset && vicinae vicinae://extensions/kraeki/google-calendar/list-events"))
