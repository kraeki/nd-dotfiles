# naptop — Framework Laptop 16 (Ryzen 7040). This file holds only what is
# true of THIS machine: hardware, boot, kernel quirks, its user. Everything
# identity-shaped comes from modules/nixos via `nd.enable = true`.
{ config, pkgs, inputs, ... }:
